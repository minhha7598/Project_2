<?php include '../../../config/db.php'; 
    if(isset($_POST['sbm'])){
        ...
        move_uploaded_file($image_tmp, 'img/'.$image_tmp);
        //Insert into Database
        $query = mysqli_query($conn, "INSERT INTO `product-data`(`Product-Name`,`Image`,`Brand`,`Quantity`,`Quality`,`Price`) VALUES ('$productname','$image','$brand','$quantity',' $quality','$price')");
            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="text-align: center;">
                        ...
                        <button type="submit" name='sbm' class='btn btn-success'>CREAT</button>  
                    </div>
                </form>
            </div>
        </div>
